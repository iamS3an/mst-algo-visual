 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Wp;function vv(){return Wp||(Wp=1,function(s){function e(V,ae){var se=V.length;V.push(ae);e:for(;0<se;){var F=se-1>>>1,re=V[F];if(0<a(re,ae))V[F]=ae,V[se]=re,se=F;else break e}}function t(V){return V.length===0?null:V[0]}function r(V){if(V.length===0)return null;var ae=V[0],se=V.pop();if(se!==ae){V[0]=se;e:for(var F=0,re=V.length,Ue=re>>>1;F<Ue;){var Q=2*(F+1)-1,me=V[Q],Me=Q+1,ye=V[Me];if(0>a(me,se))Me<re&&0>a(ye,me)?(V[F]=ye,V[Me]=se,F=Me):(V[F]=me,V[Q]=se,F=Q);else if(Me<re&&0>a(ye,se))V[F]=ye,V[Me]=se,F=Me;else break e}}return ae}function a(V,ae){var se=V.sortIndex-ae.sortIndex;return se!==0?se:V.id-ae.id}if(typeof performance=="object"&&typeof performance.now=="function"){var l=performance;s.unstable_now=function(){return l.now()}}else{var c=Date,f=c.now();s.unstable_now=function(){return c.now()-f}}var h=[],p=[],g=1,_=null,v=3,S=!1,E=!1,C=!1,y=typeof setTimeout=="function"?setTimeout:null,x=typeof clearTimeout=="function"?clearTimeout:null,I=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function L(V){for(var ae=t(p);ae!==null;){if(ae.callback===null)r(p);else if(ae.startTime<=V)r(p),ae.sortIndex=ae.expirationTime,e(h,ae);else break;ae=t(p)}}function P(V){if(C=!1,L(V),!E)if(t(h)!==null)E=!0,oe(W);else{var ae=t(p);ae!==null&&ce(P,ae.startTime-V)}}function W(V,ae){E=!1,C&&(C=!1,x(U),U=-1),S=!0;var se=v;try{for(L(ae),_=t(h);_!==null&&(!(_.expirationTime>ae)||V&&!G());){var F=_.callback;if(typeof F=="function"){_.callback=null,v=_.priorityLevel;var re=F(_.expirationTime<=ae);ae=s.unstable_now(),typeof re=="function"?_.callback=re:_===t(h)&&r(h),L(ae)}else r(h);_=t(h)}if(_!==null)var Ue=!0;else{var Q=t(p);Q!==null&&ce(P,Q.startTime-ae),Ue=!1}return Ue}finally{_=null,v=se,S=!1}}var O=!1,N=null,U=-1,R=5,w=-1;function G(){return!(s.unstable_now()-w<R)}function le(){if(N!==null){var V=s.unstable_now();w=V;var ae=!0;try{ae=N(!0,V)}finally{ae?ee():(O=!1,N=null)}}else O=!1}var ee;if(typeof I=="function")ee=function(){I(le)};else if(typeof MessageChannel<"u"){var de=new MessageChannel,ge=de.port2;de.port1.onmessage=le,ee=function(){ge.postMessage(null)}}else ee=function(){y(le,0)};function oe(V){N=V,O||(O=!0,ee())}function ce(V,ae){U=y(function(){V(s.unstable_now())},ae)}s.unstable_IdlePriority=5,s.unstable_ImmediatePriority=1,s.unstable_LowPriority=4,s.unstable_NormalPriority=3,s.unstable_Profiling=null,s.unstable_UserBlockingPriority=2,s.unstable_cancelCallback=function(V){V.callback=null},s.unstable_continueExecution=function(){E||S||(E=!0,oe(W))},s.unstable_forceFrameRate=function(V){0>V||125<V?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):R=0<V?Math.floor(1e3/V):5},s.unstable_getCurrentPriorityLevel=function(){return v},s.unstable_getFirstCallbackNode=function(){return t(h)},s.unstable_next=function(V){switch(v){case 1:case 2:case 3:var ae=3;break;default:ae=v}var se=v;v=ae;try{return V()}finally{v=se}},s.unstable_pauseExecution=function(){},s.unstable_requestPaint=function(){},s.unstable_runWithPriority=function(V,ae){switch(V){case 1:case 2:case 3:case 4:case 5:break;default:V=3}var se=v;v=V;try{return ae()}finally{v=se}},s.unstable_scheduleCallback=function(V,ae,se){var F=s.unstable_now();switch(typeof se=="object"&&se!==null?(se=se.delay,se=typeof se=="number"&&0<se?F+se:F):se=F,V){case 1:var re=-1;break;case 2:re=250;break;case 5:re=1073741823;break;case 4:re=1e4;break;default:re=5e3}return re=se+re,V={id:g++,callback:ae,priorityLevel:V,startTime:se,expirationTime:re,sortIndex:-1},se>F?(V.sortIndex=se,e(p,V),t(h)===null&&V===t(p)&&(C?(x(U),U=-1):C=!0,ce(P,se-F))):(V.sortIndex=re,e(h,V),E||S||(E=!0,oe(W))),V},s.unstable_shouldYield=G,s.unstable_wrapCallback=function(V){var ae=v;return function(){var se=v;v=ae;try{return V.apply(this,arguments)}finally{v=se}}}}(Lc)),Lc}var Xp;function xv(){return Xp||(Xp=1,bc.exports=vv()),bc.exports}/**
 * @license React
...
`].filter(Xo).join(`
`)),c=td(c),c=Hm(c,t),c=Vm(c,t),f=td(f),f=Hm(f,t),f=Vm(f,t),c=Gm(c),f=Gm(f),t.isRawShaderMaterial!==!0&&(I=`#version 300 es
